...
// Hauptobjekt für alle Meeting-Phrasen mit klarer Kategorisierung
const meetingPhrases = {
  // Allgemeine Phrasen (vorher verteilt auf participantPhrases, discussionPhrases, GENERAL_PHRASES)
  general: {
    normal: [
      // Standard Diskussionsphrasen
      "Das sehe ich anders...",
    ...
    shouting: [
      // Verärgerte/laute allgemeine Ausrufe
  ...
  // Better Place to Work & Mobilitätsthemen
  mobility: {
    normal: [
      // Betriebsrad/Arbeitsplatz-bezogene Themen
      ...
      // Auto- und Parkplatz-bezogene Themen
    ...
    shouting: [
      // Verärgerte/laute Betriebsrad- und Firmenwagen-Ausrufe
  ...
  genZ: {
    ...
    shouting: [
      // Verärgerte/laute Gen-Z Ausrufe
...
// Hilfsfunktion, um geteilte Phrasen für den Gen-Z spezifischen Content zu erhalten
...
// Hilfsfunktion, um geteilte Phrasen für die allgemeinen Teilnehmer zu erhalten
